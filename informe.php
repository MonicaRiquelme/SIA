<?php
	 ...
	 $registro = mysql_query("SELECT * FROM Repuesto Where Descripcion LIKE '$de' ") or die ("problemas en consulta:".mysql_error());
...
$pdf->Cell(27,6,utf8_decode(' '.$_POST['equipo']),1,0,'C');
...
$pdf->Cell(27,6,utf8_decode(' '.$reg1['Precio-Unitario']),1,0,'C');
$total= $_POST['cantidad']*$reg1['Precio-Unitario'];
